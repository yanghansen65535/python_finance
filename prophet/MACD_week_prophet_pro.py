...
#print(pd.date_range(data_plot.index[-1] + timedelta(days=7), data_plot.index[-1]+timedelta(days=prophet_week*7), freq=period_type))
#print(data_plot.index)
